...
Unity Technical Developer with 6+ years of experience in mobile and PC projects. Specialized in technical infrastructure: SDK integration, project migration, Editor tools development, and process automation. Proactive problem-solver who's not afraid to tackle new complex technical challenges.

**Core Competencies:**
- **SDK Integration & Migration:** Unity project upgrades (including major versions), SDK integration (Facebook, AppLovin, Firebase, AltTester), Unity Analytics implementation, legacy code refactoring
- **Tools Development:** Editor tools development (visual editors, automation), automation systems (localization, component relinking via reflection), workflow optimization tools
- **Game Systems:** Prototyping and development of game systems (physics, AI, UI, networking), development team coordination
- **Additional:** DevOps (AWS, CI/CD, reduced build time by 50%+), Game Design (4+ years), QA automation

**Projects:**  
Worked on multiplayer mobile games ([Offroad Outlaws](https://play.google.com/store/apps/details?id=com.battlecreek.offroadoutlaws), [No Limits Drag Racing 2](https://play.google.com/store/apps/details?id=com.battlecreek.nolimit2), [Grand Wars](https://play.google.com/store/apps/details?id=com.gdcompany.grandwars.mafiacity), [Steel Rage](https://play.google.com/store/apps/details?id=com.gdcompany.robocars.shooterwarfare)) and internal studio prototypes.
...
Integration and updating of SDKs (Facebook, AppLovin, Firebase), Unity project migration (major/minor versions, breaking changes, API updates), Unity Analytics integration, legacy code maintenance, architecture refactoring, third-party packages and assets integration

**Tools Development & Automation**  
Editor tools development (visual editors, automation tools), Unity Localization + DeepL API integration, automation via reflection, Google Apps Script integration, Selenium automation, workflow optimization tools

**Unity and C# Development**  
C#, Unity Editor, UI Toolkit, Unity DOTS/ECS, Photon, Jobs System, Physics, Animator, Timeline, Reflection, OOP, SOLID, systems prototyping

**DevOps & CI/CD**  
AWS (EC2, AMI snapshots, monitoring), GitHub Actions (workflows, caching, versioning), Fastlane (Google Play, TestFlight deployment), Docker, monitoring (Grafana, CloudWatch), incident management

**Performance & Quality**  
Performance optimization, profiling (Profiler, Frame Debugger), QA automation (performance testing, C# API for metrics), UX analysis, code review

**Game Design & Content**  
Game Design Documents, mechanics design, level design, content balancing, FTUE (First Time User Experience), content integration into projects

**Tools and Processes**  
Git, Plastic SCM, Jira, Trello, Notion, Visual Studio, Rider, Agile methodologies, code review, technical documentation, incident management
...
Technical Developer and DevOps Engineer for two multiplayer mobile projects (Android/iOS). Focus on technical infrastructure: project migration, SDK integration, AWS infrastructure design, CI/CD pipeline automation, automated testing integration. Problem-solving approach to all technical challenges.
...
Technical Unity Developer: Editor tools development, SDK integration and automation, Unity Analytics implementation, localization, network code (Photon). Game systems prototyping. Additionally: Game Design (GDD, level design, content balancing).
...
✔ Developed automatic weapon balance generation tool in Google Sheets with Google Apps Script: button-click item generation with full stat calculations, automatic addition to game config (used in Grand Wars)
...
**Projects:** [Grand Wars](https://play.google.com/store/apps/details?id=com.gdcompany.grandwars.mafiacity), [Steel Rage](https://play.google.com/store/apps/details?id=com.gdcompany.robocars.shooterwarfare)

Unity Technical Developer: technical implementation of game systems, SDK integration, project migration, content integration. Additionally: Game Design (GDD, balancing, level design) and second game designer leadership.
